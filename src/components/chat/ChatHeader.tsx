...
export default function ChatHeader({
  ...
  return (
    <div className="flex items-center justify-between border-b border-slate-200/50 bg-white/60 backdrop-blur-md px-4 py-3 sticky top-0 z-10">
      ...
      <button
        className={cn(
          'inline-flex items-center gap-2 rounded-xl px-3 py-1.5 text-sm text-slate-500 hover:bg-slate-100/70 transition-colors',
      ...
      >
        ...
        <span className="font-light text-xs">清空</span>
      </button>
    </div>
  )
}
